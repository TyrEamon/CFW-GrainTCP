...
const PANEL_CONFIG_KEYS = [
  ...
  'CF_EMAIL','CF_KEY','PROXYIP','SUB_DOMAIN','SUBAPI','PS','LOGIN_PAGE_TITLE',
...
function panelSetCookie(request, env, password) {
  ...
  return `auth=${clean}; Path=/; Max-Age=604800; HttpOnly${secure}; SameSite=${sameSite}`;
}
